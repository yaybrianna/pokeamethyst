...
static const u8 sXSpecialAttackDesc[] = _(
    "Raises the stat\n"
    "Special Attack during\n"
    "one battle.");

static const u8 sXSpecialDefenseDesc[] = _(
    "Raises the stat\n"
    "Special Defense during\n"
    "one battle.");
...
static const u8 sSoulDewDesc[] = _(
    "Raises Special Attack\n"
    "and Special defense of\n"
    "Latios & Latias when held.");

static const u8 sDeepSeaToothDesc[] = _(
    "A hold item that\n"
    "raises the Special Attack\n"
    "of Clamperl.");
